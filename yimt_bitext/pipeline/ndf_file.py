...
from yimt_bitext.filter.filters import EmptyFilter, SameFilter, OverlapFilter, AlphabetRatioFilter, RepetitionFilter, \
    CharacterRatioFilter, get_lang2script
...
if __name__ == "__main__":
    ...
    ndf_file(in_file, source_lang, clean_after_done=False, logger=logger_opus)
